...
$.get("${APP_PATH}/staff.do?logou");

/*
$.ajax({
				url:"${APP_PATH}/staff.do?logout",
				type:"POST",
				success:
				function(result)
				{
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					<li class="green"><a 
						 href="ema.do?findAll" target="mainframe"> <i
							class="icon-envelope icon-animated-vertical"></i> <span
							class="badge badge-success">邮件</span>
					</a>
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							<font style="Bold" color="#FF0000">${staffLogin[0].name}</font>
							</small>
						...
						<ul
							...
							<li><a href="UserInfo.jsp"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="login.jsp" onClick="logout()"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
			...
			<div class="sidebar" id="sidebar">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						...
						<button class="btn btn-info" data-toggle="tooltip" title="文件操作">
							<a href="view/filework/upAndDownFile.jsp" target="mainframe">
						...
						<button class="btn btn-danger" data-toggle="tooltip" title="播放文件"><a href="upfile.do?play" target="mainframe">
							<i class="icon-cogs"></i>					</a>	</button>
					</div>
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="staff.do?findStaff" target="mainframe"> <i
									class="icon-double-angle-right"></i> 员工管理
							</a></li>
                            <li><a href="role.do?roleFind" target="mainframe"> <i
									class="icon-double-angle-right"></i> 角色管理
							</a></li>
									
                          <li><a href="anthorty.do?all" target="mainframe"> <i
									class="icon-double-angle-right"></i> 权限管理	</a></li> 
									
						  <li><a href="role.do?rsChange" target="mainframe"> <i
									class="icon-double-angle-right"></i> 员工角色的变更	</a></li>
									
                         <li><a href="anthorty.do?findRole" target="mainframe"> <i
									class="icon-double-angle-right"></i> 员工权限的变更</a></li>  
